...
public class FileIO {
    static final String PATH = "C:\\Users\\Vitthal\\IdeaProjects\\Day10_Assignment_Problem\\src\\main\\java\\addressbooks";
    ...
    public static void writeTxt(ArrayList<Contact> list, String addressBookName) throws IOException {
        ...
        for (Contact contact : list)
            contactDataString = contactDataString.concat(contact.toString().concat("\n"));
    ...
    public static void writeCSV(ArrayList<Contact> list, String addressBookName) throws IOException {
        ...
        for (Contact contacts : list) {
            String[] contactData = new String[]{contacts.getFirstName(), contacts.getLastName(), contacts.getAddress(), contacts.getCity(), contacts.getState(),contacts.getMobileNumber(), contacts.getZip(), contacts.getEmail()};
